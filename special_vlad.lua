...
-- Автор (изменено на специальную надпись)
G2L["4"] = Instance.new("TextLabel", G2L["2"]);
G2L["4"]["BorderSizePixel"] = 0;
G2L["4"]["TextSize"] = 14; -- Уменьшен размер текста
...
G2L["4"]["Size"] = UDim2.new(0, 220, 0, 39); -- Увеличена ширина
G2L["4"]["BorderColor3"] = Color3.fromRGB(255, 255, 255);
G2L["4"]["Text"] = [[Специально для 00xlbis00]];
G2L["4"]["Name"] = [[Author]];
G2L["4"]["Position"] = UDim2.new(0.05, 0, 0.90538, 0); -- Сдвинуто левее
...
-- Инициализация
updateActionButton()
updateTargetsList() -- Обновляем список при старте
G2L["2"].Visible = false
